...
`,z=async()=>(F??=d(()=>import(`./chunk-C8B1hhlr2.js`),__vite__mapDeps([0,1])),F),B=(e,t)=>e.replace(/<svg\b([^>]*?)>/,(e,t)=>{let n=t.match(/\sclass="([^"]*)"/);if(n){let e=`${n[1]} ${I}`.trim();return`<svg${t.replace(/\sclass="([^"]*)"/,` class="${e}"`)} data-mermaid-graphic="">`}return`<svg${t} class="${I}" data-mermaid-graphic="">`}).replace(`</svg>`,`<style>${R(t)}</style></svg>`),V=({source:e})=>(0,v.jsx)(`pre`,{className:`sr-only`,"data-mermaid-source":``,children:(0,v.jsx)(`code`,{children:e})}),H=({className:e,source:t})=>{let[n,r]=(0,_.useState)(null),[i,o]=(0,_.useState)(null),s=(0,_.useId)();return(0,_.useEffect)(()=>{let e=!0;return(async()=>{try{let{renderMermaidSvg:n}=await z(),i=await n(`nivel-mermaid-${s}`,t);if(!e)return;r(B(i,`nivel-mermaid-${s}`)),o(null)}catch(t){if(!e)return;let n=t instanceof Error?t.message:`Failed to render Mermaid diagram.`;o(n),r(null)}})(),()=>{e=!1}},[s,t]),i?(0,v.jsxs)(`div`,{className:a(L,`space-y-3`,e),"data-mermaid-diagram":``,"data-mermaid-status":`error`,children:[(0,v.jsx)(`div`,{className:`rounded-box border border-error/30 bg-error/8 px-4 py-3 text-sm text-error`,children:i}),(0,v.jsx)(`pre`,{className:`doc-code-pre m-0 overflow-x-auto bg-base-200! p-4 text-sm`,children:(0,v.jsx)(`code`,{children:t})})]}):n?(0,v.jsxs)(`div`,{className:a(L,`overflow-x-auto bg-base-200 px-3 py-4 [&_svg]:mx-auto [&_svg]:h-auto [&_svg]:max-w-full`,e),"data-mermaid-diagram":``,"data-mermaid-status":`ready`,children:[(0,v.jsx)(`div`,{dangerouslySetInnerHTML:{__html:n}}),(0,v.jsx)(V,{source:t})]}):(0,v.jsxs)(`div`,{className:a(L,`space-y-3`,e),"data-mermaid-diagram":``,"data-mermaid-status":`loading`,children:[(0,v.jsxs)(`div`,{className:`px-4 py-10 text-center text-sm flex gap-2 items-center justify-center`,children:[(0,v.jsx)(`span`,{className:`loading loading-spinner loading-md`}),`Rendering diagram...`]}),(0,v.jsx)(V,{source:t})]})},U=e=>typeof e==`string`&&e.trim()?e.trim():null,W=e=>{let t=_.Children.toArray(e)[0];if(!(0,_.isValidElement)(t))return null;let n=t.props,r=U(n[`data-language`]);if(r)return r;let i=(typeof n.className==`string`?n.className.split(/\s+/):[]).find(e=>e.startsWith(`language-`));return i?i.slice(9):null},ue=e=>{let t=U(e[`data-language-label`]);if(t)return t;let n=U(e[`data-language`])??W(e.children);return n?n.toUpperCase():`CODE`},G=e=>typeof e==`string`||typeof e==`number`?String(e):Array.isArray(e)?e.map(e=>G(e)).join(``):(0,_.isValidElement)(e)?G(e.props.children):``,de=({children:e,className:t,...n})=>{let r=(0,_.useRef)(null),i=te(),o=U(n[`data-language`])??W(e),s=U(n[`data-code-title`])??ue({...n,children:e,"data-language":o??void 0}),c=U(n[`data-code-env`]),l=n[`file-added`]?`added`:n[`file-removed`]?`removed`:null,u=n[`hide-menu`]===`true`,d=o===`mermaid`&&n.render===`true`,f=S(G(e)),p=u||i?null:(0,v.jsx)(C,{actionDetail:{action:`code.copy`,component:`code-block`,env:c,label:s,language:o},onCopy:async()=>{let e=d?f:S(r.current?.textContent??``);try{return await navigator.clipboard.writeText(e),!0}catch{return!1}}});return(0,v.jsxs)(`div`,{className:a(`group relative h-full min-w-0 max-w-full not-prose overflow-hidden`,i?``:`rounded-box border border-base-muted-light`,t),"data-code-block-frame":``,"data-file-state":l??void 0,"data-nivel-component":`code-block`,children:[!i&&(0,v.jsxs)(`div`,{className:`flex min-h-10 relative items-center justify-between gap-3 border-b border-base-muted-light bg-base-muted-superlight! px-4`,"data-code-block-header":``,children:[(0,v.jsx)(y,{label:s,env:c}),p]}),d?(0,v.jsx)(H,{className:`min-w-0`,source:f}):(0,v.jsx)(`pre`,{...n,ref:r,className:a(`doc-code-pre m-0 h-full min-w-0 max-w-full overflow-x-auto bg-base-200! p-4 text-sm`,t),"data-code-block-content":``,children:e})]})},fe={info:h,warning:g,error:p,success:f},K=({type:e=`info`,heading:t,children:n,icon:r=!0})=>{let i=r===!0?fe[e]:typeof r==`object`?()=>(0,v.jsx)(v.Fragment,{children:r}):null,o={info:`text-info`,warning:`text-warning`,error:`text-error`,success:`text-success`}[e];return(0,v.jsxs)(pe,{$variant:e,children:[!!t&&i&&(0,v.jsxs)(`div`,{className:`mb-3 flex items-center gap-2`,children:[(0,v.jsx)(i,{className:a(o,`float-left h-5 w-5`)}),(0,v.jsx)(q,{children:t})]}),!(t&&i)&&!!t&&(0,v.jsx)(q,{children:t}),!(t&&i)&&i&&(0,v.jsx)(`div`,{className:a(o,`float-left mr-2`),children:(0,v.jsx)(i,{className:`mt-1 h-5 w-5`})}),n]})},pe=l.section.variants({base:`
    p-4
    my-6
    border
    rounded-lg
    ...
    prose-ul:last:mb-0
    text-sm
  `,variants:{$variant:{info:`bg-info/10 border-info/30`,warning:`bg-warning/10 border-warning/30`,error:`bg-error/10 border-error/25`,success:`bg-success/10 border-success/35`}},defaultVariants:{$variant:`info`}}),q=l.header`
  font-bold
  text-base
`;function J(e,t){if(!e)throw Error(`[UniversalMdxMods][Wrong Usage] ${t}`)}var me=e=>{let t=[],n;for(let r of e.split(``)){if(r==="`"){n?.nodeType===`code`?(t.push(n),n=void 0):(n&&t.push(n),n={nodeType:`code`,content:``});continue}n??={nodeType:`text`,content:``},n.content+=r}return n&&t.push(n),(0,v.jsx)(v.Fragment,{children:t.map((e,t)=>e.nodeType===`code`?(0,v.jsx)(`code`,{children:e.content},t):(0,v.jsx)(`span`,{children:e.content},t))})},he=e=>{let t=e.split(`#`)[1];return t?t.split(`:~:text`)[0]?.split(`-`).map((e,t)=>t===0?`${e[0]?.toUpperCase()??``}${e.slice(1)}`:e).join(` `):null},ge=e=>!e.startsWith(`/`)&&!e.startsWith(`#`)&&!o(e)&&!e.startsWith(`./`)&&!e.startsWith(`../`),Y=e=>typeof e==`string`?me(e):e,_e=({isCurrentPage:e,breadcrumb:t,noBreadcrumb:n,sectionTitle:r,title:i})=>{let a=[];return t&&a.push(...t.map(e=>Y(e))),i&&a.push(Y(i)),r&&a.push(Y(r)),n||e?a[a.length-1]??null:(0,v.jsx)(v.Fragment,{children:a.map((e,t)=>(0,v.jsxs)(`span`,{children:[t>0?` > `:null,e]},t))})},X=({href:e,text:t,noBreadcrumb:n,doNotInferSectionTitle:r,noWarning:s,children:l,className:u,...d})=>{let f=i();if(typeof e!=`string`||e===``)return(0,v.jsx)(`a`,{className:a(u,`inline-flex gap-1 items-center`),...d,children:t??l??`LINK-TARGET-NOT-FOUND`});J(e.startsWith(`/`)||e.startsWith(`#`)||o(e)||ge(e),`<Link href /> prop \`href==='${e}'\` but should be external, docs-relative, or start with '/' or '#'`),J(!t||!l,"Cannot use both `text` or `children`");let p=t??l,m=f?.resolveDocLink?.({href:e,doNotInferSectionTitle:r,noWarning:s}),h=m?.href??f?.localizeHref?.(e)??c(e),g=m?.sectionTitle??(r?null:he(e)),_=p??(m?_e({breadcrumb:m.breadcrumb,isCurrentPage:m.isCurrentPage,noBreadcrumb:n,sectionTitle:g??void 0,title:m.title}):o(e)?e:g??`LINK-TARGET-NOT-FOUND`);return(0,v.jsx)(`a`,{href:h,className:a(u,``),...d,children:_})},ve=e=>typeof e==`object`&&!!e&&`dividerText`in e,ye=(e,t)=>{if(!e)throw Error(`[UniversalMdxMods][Wrong Usage] ${t}`)},be=e=>{let t=[],n={items:[]},r=()=>{n.items.length>0&&t.push(n)};for(let t of e){if(ve(t)){r(),n={dividerText:t.dividerText,items:[]};continue}n.items.push(t)}return r(),t},xe=({href:e,title:t,excerpt:n})=>(0,v.jsxs)(Se,{href:c(e),children:[(0,v.jsx)(`span`,{className:`text-lg font-semibold text-base-content`,children:u(t)}),n?(0,v.jsx)(`p`,{className:`text-sm leading-relaxed text-base-muted`,children:u(n)}):null]}),Se=l.a`
