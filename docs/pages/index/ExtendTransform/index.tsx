  ...
  return (
    <div className="relative mt-32 mb-16 ">
      <div className="absolute top-0 left-0 right-0 h-[50svh] z-0">
        <img src="/bg-dark-alt1.png" alt="" className="hidden dark:block absolute w-full h-full object-fill" />
        <img src="/bg-light-alt1.png" alt="" className="dark:hidden absolute w-full h-full object-fill" />
