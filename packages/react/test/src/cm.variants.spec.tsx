...
describe('cm variants', () => {
  ...
  it('supports boolean variants with default values', () => {
    ...
    const { container, rerender } = render(<ToolBlock $isEmpty />)
    ...
    rerender(<ToolBlock $isEmpty={false} />)
    expect(container.firstChild).toHaveClass('flex flex-wrap gap-2 bg-base-200')
