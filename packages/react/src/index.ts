 ...
 *
 * Each styled component created via `ma` filters out `$`-prefixed props from the DOM and computes a final `className`
...
export { default as useMarmo } from './useMarmo'

export default ma

/** the `twMerge` lib from @marmo/react */
