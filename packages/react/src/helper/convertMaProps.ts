 ...
 * Mainly used if you wanna "mirror" properties from a component to a marmo component.
 *
 ...
 * }
 */
const convertMaProps = <T extends object, BaseProps extends object, K extends keyof BaseProps & keyof T>(
  props: T,
  ...
  for (const key of Object.keys(source)) {
    if (key in mappings) {
      result[mappings[key as K]] = source[key]
    } else {
